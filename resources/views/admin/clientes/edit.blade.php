    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Editando o Usuario.:  {{ $user->name }}</div>
                <div class="panel-body">
                    {!! Form::model($user,['route' => ['admin.clientes.alterar',$user->id]]) !!}
                        ...
                        <div class="form-group">
                            {!!  Form::label('role', 'Tipo:', ['class' => 'col-sm-2 control-label text-right'])  !!}
                            <div class="col-sm-10">
