            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('phpone') ? ' has-error' : '' }}">
                            <label for="phpone" class="col-md-4 control-label">Telefone.:</label>

                            <div class="col-md-6">
                                <input id="phpone" type="text" class="form-control" name="phpone" value="{{ old('phpone') }}" required autofocus pattern="\([0-9]{2}\)[\s][0-9]{4}-[0-9]{4,5}">

                                @if ($errors->has('phpone'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('phpone') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
